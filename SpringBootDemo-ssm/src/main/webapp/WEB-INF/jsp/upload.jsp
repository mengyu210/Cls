...
<head>
 <meta charset="utf-8">
  ...
  <link rel="stylesheet" href="plugins/layui1/css/layui.css" media="all" />
...
<body>
  ...
  <!-- <script type="text/javascript" src="plugins/layui/layui.js"></script> -->
   <script type="text/javascript" src="plugins/layui1/layui.all.js"></script>
   ...
   layui.use('upload', function(){
	 ...
	 //多文件列表示例
	   ...
	   ,uploadListIns = upload.render({
	     elem: '#testList'
	     ,url: '/ClsRecord/uploadFile.action '
	     ,accept: 'file'
	     ,multiple: true
	     ,auto: false
